    ...
    return (
        <div className="space-y-8">
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-white">Continuous Beam Analysis</h2>
                    <p className="text-muted-foreground">Analyze multi-span beams using Slope Deflection Method</p>
                </div>
                <Button
                    size="lg"
                ...
                >
                    <Play className="mr-2 h-4 w-4" /> Analyze Beam
                </Button>
            </div>
